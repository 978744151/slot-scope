<template>
    <div class="yuandou">
        ...
        <v-touch class="zfbrun_content wrapper"  v-on:swipeleft="swiperleft" v-on:swiperight="swiperright" >
            <div class="category">
                ...
                <span :class="{'on' :color === 3}" @click="changetixian(3)">充值</span>
            </div>
                    ...
                    <div class="zfbrun_list liaotian" v-show=" color === color" v-for="(items,index) in yuandoulist" :key="index">
                        <div class="zfbrun_box">
                            ...
                            <div class="zfbrun_box_right" v-else-if="color == 2">
                             ...
                             <div class="zfbrun_box_right" v-else-if="color == 3">
                                <p>+{{items.expensenum}}</p>
...
export default {
    ...
    methods: {
        ...
        getListDataFromNet(color, pageNum, pageSize, successCallback, errorCallback) {
            ...
            // console.log(data)
            axios.get('http://yue.wojianwang.com:8080/api/api-bin/ywms/data/selectExpenseRecord.action', { params: data }).then(res => {
